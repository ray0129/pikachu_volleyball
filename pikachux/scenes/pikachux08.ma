...
//Name: pikachux8.ma
//Last modified: Wed, Jan 02, 2019 11:12:11 PM
//Codeset: 950
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.9134049444599501 14.614122152992358 49.727862315557452 ;
	setAttr ".r" -type "double3" -5.7383527268082659 1433.0000000001683 5.006937643722619e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "96D5F24E-4293-D631-8851-159BCC7D14AA";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 53.105275702395978;
...
createNode transform -s -n "front";
	...
	setAttr ".t" -type "double3" -0.54228190662724485 7.8933863189603715 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "0B8B98B6-404B-C23D-26F8-42A900FD4363";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 34.05728983384406;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 9.5894745846137877 1.8068488327208501 ;
...
createNode transform -n "pikachu:camera1";
	...
	setAttr ".t" -type "double3" 8.108907106000169 0 7.0414962966681172 ;
...
createNode transform -n "imagePlane1";
	...
	setAttr ".t" -type "double3" 11.952805901744467 0 -8.9526056695576166 ;
...
createNode transform -n "pCylinder1";
	rename -uid "D2C6A14E-4A49-73D0-35DF-BC8C68EC48DC";
	setAttr ".t" -type "double3" 0.57018543088873019 0.010628170025239303 0.42886148725385009 ;
	setAttr ".r" -type "double3" 107.22632674874842 48.785740992527877 0.53639908589130303 ;
	setAttr ".s" -type "double3" 0.15096595690142539 -0.013578057753254654 0.15096595690142539 ;
	setAttr ".hio" yes;
...
createNode transform -n "pCube3" -p "pCube2";
	rename -uid "1AF619AF-402D-90A1-2A47-D99C75A4D993";
	setAttr ".t" -type "double3" 0.092685431367600588 -0.083469506008529787 0.0058145938491419441 ;
	setAttr ".r" -type "double3" 0 20.586657555104988 0 ;
	setAttr ".hio" yes;
createNode transform -n "transform5" -p "|pCube2|pCube3";
	rename -uid "B303C07A-4356-7557-F396-0796E54C002C";
	setAttr ".v" no;
	setAttr ".hio" yes;
createNode mesh -n "pCubeShape3" -p "transform5";
	rename -uid "6E8E7277-42BB-36F5-5EC4-86A0C6D25CFF";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 12 ".pt";
	setAttr ".pt[11]" -type "float3" -0.059554216 0.039206371 -0.011675874 ;
	setAttr ".pt[18]" -type "float3" -0.059554216 0.039206371 -0.011675874 ;
	setAttr ".pt[58]" -type "float3" -0.059554216 0.039206371 -0.011675874 ;
	setAttr ".pt[59]" -type "float3" -0.059554216 0.039206371 -0.011675874 ;
	setAttr ".pt[82]" -type "float3" -0.059554216 0.039206371 -0.011675874 ;
	setAttr ".pt[161]" -type "float3" -0.059554216 0.039206371 -0.011675874 ;
	setAttr ".pt[162]" -type "float3" -0.059554216 0.039206371 -0.011675874 ;
	setAttr ".pt[169]" -type "float3" -0.059554216 0.039206371 -0.011675874 ;
	setAttr ".pt[191]" -type "float3" -0.059554216 0.039206371 -0.011675874 ;
	setAttr ".pt[192]" -type "float3" -0.059554216 0.039206371 -0.011675874 ;
	setAttr ".pt[202]" -type "float3" -0.059554216 0.039206371 -0.011675874 ;
	setAttr ".pt[203]" -type "float3" -0.059554216 0.039206371 -0.011675874 ;
	setAttr ".hio" yes;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode transform -n "pCube4";
	rename -uid "67C4BF45-41AE-FE0E-74CC-8B9F71A13D44";
	setAttr ".t" -type "double3" 0.37188583562883715 -0.67088460469560651 0.62094540698972722 ;
	setAttr ".r" -type "double3" 3.4457060235001489 -42.104487472851027 40.755208006583828 ;
	setAttr ".s" -type "double3" 0.17838325505791269 0.33056779576749223 0.88771972123791076 ;
	setAttr ".hio" yes;
createNode transform -n "transform4" -p "pCube4";
	rename -uid "E4965F11-495B-89FF-79F7-2B825B0DD53D";
	setAttr ".v" no;
	setAttr ".hio" yes;
...
createNode transform -n "pikachu:pCube3";
	...
	setAttr ".hio" yes;
createNode transform -n "transform3" -p "pikachu:pCube3";
	rename -uid "6FCCECDC-4F70-9130-2B6D-E3A9EF30282A";
	setAttr ".v" no;
	setAttr ".hio" yes;
createNode mesh -n "pikachu:pCube3Shape" -p "transform3";
...
createNode transform -n "group1";
	rename -uid "B36719BB-43D5-3597-C1A1-988D2D9D6A0A";
	setAttr ".t" -type "double3" 0 8.9487221671245241 0 ;
	setAttr ".s" -type "double3" 5.0865642328316945 5.0865642328316945 5.0865642328316945 ;
...
createNode mesh -n "pikachu:pCubeShape3" -p "pikachu:pCube4";
	...
	setAttr ".dr" 1;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode transform -n "pikachu:pSphere1" -p "group1";
...
createNode mesh -n "pikachu:pSphereShape1" -p "pikachu:pSphere1";
	...
	setAttr ".dr" 1;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode transform -n "pikachu:pSphere2" -p "group1";
...
createNode mesh -n "pikachu:pSphereShape2" -p "pikachu:pSphere2";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode transform -n "pikachu:pSphere3" -p "group1";
...
createNode transform -n "pCube3" -p "group1";
	rename -uid "F83D22A9-4163-E0F4-DB94-2EAAEB1EF27C";
	setAttr ".rp" -type "double3" -8.9406967163085938e-08 -0.30232331156730652 0.16520139575004578 ;
	setAttr ".sp" -type "double3" -8.9406967163085938e-08 -0.30232331156730652 0.16520139575004578 ;
createNode mesh -n "pCube3Shape" -p "|group1|pCube3";
	rename -uid "4233D6D1-4E07-A471-F878-BF984E9A3436";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.6876949667930603 0.078323669731616974 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 56 ".pt";
	setAttr ".pt[0]" -type "float3" 0.014546144 0 0 ;
	setAttr ".pt[1]" -type "float3" 0.032164268 0 0 ;
	setAttr ".pt[2]" -type "float3" 0.021474797 0 0 ;
	setAttr ".pt[12]" -type "float3" 0.030876763 0 0 ;
	setAttr ".pt[58]" -type "float3" 0.013200855 0 0 ;
	setAttr ".pt[67]" -type "float3" 0.013130893 0 0 ;
	setAttr ".pt[68]" -type "float3" 0.029245941 0 0 ;
	setAttr ".pt[75]" -type "float3" 0.02900669 0 0 ;
	setAttr ".pt[96]" -type "float3" 0.020318326 0 0 ;
	setAttr ".pt[156]" -type "float3" 0.0031170368 0 0 ;
	setAttr ".pt[594]" -type "float3" 0.031288423 0 0 ;
	setAttr ".pt[608]" -type "float3" 0.013130893 0 0 ;
	setAttr ".pt[648]" -type "float3" 0.013999024 0 0 ;
	setAttr ".pt[672]" -type "float3" 0.02900669 0 0 ;
	setAttr ".pt[696]" -type "float3" 0.012968568 0 0 ;
	setAttr ".pt[709]" -type "float3" 0.032742478 0 0 ;
	setAttr ".pt[717]" -type "float3" 0.031118631 0 0 ;
	setAttr ".pt[739]" -type "float3" 0.030876763 0 0 ;
	setAttr ".pt[774]" -type "float3" 0.013311028 0 0 ;
	setAttr ".pt[787]" -type "float3" 0.032164268 0 0 ;
	setAttr ".pt[802]" -type "float3" 0.03174679 0 0 ;
	setAttr ".pt[828]" -type "float3" 0.013210493 0 0 ;
	setAttr ".pt[836]" -type "float3" 0.01406116 0 0 ;
	setAttr ".pt[853]" -type "float3" 0.031118631 0 0 ;
	setAttr ".pt[882]" -type "float3" 0.013489334 0 0 ;
	setAttr ".pt[915]" -type "float3" 0.014546146 0 0 ;
	setAttr ".pt[937]" -type "float3" 0.013210493 0 0 ;
	setAttr ".pt[955]" -type "float3" 0.013999024 0 0 ;
	setAttr ".pt[1066]" -type "float3" -0.012876706 0 0 ;
	setAttr ".pt[1101]" -type "float3" -0.031185551 0 0 ;
	setAttr ".pt[1106]" -type "float3" -0.013130895 0 0 ;
	setAttr ".pt[1138]" -type "float3" -0.014061151 0 0 ;
	setAttr ".pt[1140]" -type "float3" -0.029006675 0 0 ;
	setAttr ".pt[1148]" -type "float3" -0.013200853 0 0 ;
	setAttr ".pt[1188]" -type "float3" -0.030876763 0 0 ;
	setAttr ".pt[1189]" -type "float3" -0.029245943 0 0 ;
	setAttr ".pt[1191]" -type "float3" -0.014546144 0 0 ;
	setAttr ".pt[1207]" -type "float3" -0.013130895 0 0 ;
	setAttr ".pt[1231]" -type "float3" -0.031288415 0 0 ;
	setAttr ".pt[1234]" -type "float3" -0.032164264 0 0 ;
	setAttr ".pt[1239]" -type "float3" -0.012968567 0 0 ;
	setAttr ".pt[1245]" -type "float3" -0.029006675 0 0 ;
	setAttr ".pt[1247]" -type "float3" -0.013999021 0 0 ;
	setAttr ".pt[1267]" -type "float3" -0.013311026 0 0 ;
	setAttr ".pt[1270]" -type "float3" -0.03111863 0 0 ;
	setAttr ".pt[1271]" -type "float3" -0.030876763 0 0 ;
	setAttr ".pt[1275]" -type "float3" -0.032742478 0 0 ;
	setAttr ".pt[1279]" -type "float3" -0.013210492 0 0 ;
	setAttr ".pt[1286]" -type "float3" -0.032164264 0 0 ;
	setAttr ".pt[1289]" -type "float3" -0.014061151 0 0 ;
	setAttr ".pt[1291]" -type "float3" -0.031746786 0 0 ;
	setAttr ".pt[1296]" -type "float3" -0.013489323 0 0 ;
	setAttr ".pt[1302]" -type "float3" -0.03111863 0 0 ;
	setAttr ".pt[1309]" -type "float3" -0.013210492 0 0 ;
	setAttr ".pt[1311]" -type "float3" -0.014546143 0 0 ;
	setAttr ".pt[1315]" -type "float3" -0.013999021 0 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".dr" 1;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode transform -n "pikachu:group" -p "group1";
	rename -uid "0389513A-4D9B-92D3-B32B-6D8AEBC234EA";
	setAttr ".t" -type "double3" 3.2734652600717062 0 -0.57286607433565795 ;
	setAttr ".r" -type "double3" -2.6001660222242817 0.03205620990952688 0.70585167481041877 ;
...
createNode transform -n "pikachu:pasted__pasted__pCube7" -p "pikachu:group";
	...
	setAttr ".t" -type "double3" -3.1189845073846256 -0.78760287711506238 0 ;
...
createNode joint -n "joint17";
	rename -uid "2E779901-4FFA-321B-6472-B6AEA6706986";
	setAttr ".t" -type "double3" 0.026920708980175179 2.6282621245917186 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 89.999999999999986 ;
	setAttr ".radi" 0.53292021654506916;
createNode joint -n "joint18" -p "joint17";
	rename -uid "0F90DDA2-47A0-9D59-0C3A-C096AF2CE534";
	setAttr ".t" -type "double3" 1.636457519871338 3.6336656347642782e-16 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".radi" 0.53537367609510123;
createNode joint -n "joint19" -p "joint18";
	rename -uid "E8A02662-43AD-281B-BE93-4B849EACA6BA";
	setAttr ".t" -type "double3" 1.6838910711719564 3.7389892763516483e-16 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 -0.84252426074054543 ;
	setAttr ".radi" 0.53170250635430405;
createNode joint -n "joint20" -p "joint19";
	rename -uid "85A6DDFE-43CA-521B-B345-64BEC7FE077D";
	setAttr ".t" -type "double3" 1.6129151228498793 3.4416913763379853e-15 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 180 -8.4084914977855591e-30 1.316032319475428 ;
	setAttr ".radi" 0.59671523389064851;
createNode joint -n "joint21" -p "joint20";
	rename -uid "235D05C8-49A9-7D15-C66A-96BE61347298";
	setAttr ".t" -type "double3" 2.8698278552192038 -3.4104663537704027e-15 -4.1677123996539784e-31 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 180 7.0622500768802538e-31 90.473508058734865 ;
	setAttr ".radi" 0.59671523389064851;
createNode joint -n "joint13" -p "joint21";
	rename -uid "C1C8F52A-4014-D806-9EB5-CE84BE6A5C87";
	setAttr ".t" -type "double3" 2.0396427059265947 2.0633594815769047 8.2473249394393202e-19 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 9.7801577069033458e-15 -1.4153350110836501e-15 53.471144633014866 ;
	setAttr ".radi" 0.57193241396005856;
createNode joint -n "joint14" -p "joint13";
	rename -uid "83B6BDA9-4CFB-8B50-1919-1282DA5DC76F";
	setAttr ".t" -type "double3" 2.3906933365611316 -4.4408920985006262e-16 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 -53.471144633014866 ;
	setAttr ".radi" 0.57193241396005856;
createNode joint -n "joint15" -p "joint21";
	rename -uid "6DA2F39C-48AE-B09E-0ADC-8A8D10D46338";
	setAttr ".t" -type "double3" -2.0934807089801746 2.063318686456542 5.0696412899979823e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -180 9.7681271409230526e-15 -53.471144633014887 ;
	setAttr ".radi" 0.57193241396005856;
createNode joint -n "joint16" -p "joint15";
	rename -uid "7B604182-4D34-CF12-F7DD-05B90E84348C";
	setAttr ".t" -type "double3" -2.3907284809505231 -2.1725805594563496e-05 2.6606438279544559e-21 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 1.2074182725659036e-06 -5.6383273325948514e-15 -53.471144633014873 ;
	setAttr ".radi" 0.57193241396005856;
createNode joint -n "joint7" -p "joint19";
	rename -uid "0B120BE8-43A3-5BC7-3BDF-4891F6B588AD";
	setAttr ".t" -type "double3" 0.19281635380209039 -2.4017122955041152 1.8922622438451437 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 180 7.0167092985348775e-15 131.58367813857021 ;
	setAttr ".radi" 0.5221144307817196;
createNode joint -n "joint8" -p "joint7";
	rename -uid "ABBC963B-4306-4FDF-1F4D-A690C31D4B27";
	setAttr ".t" -type "double3" 0.62293987382607263 -0.16529166386110464 -1.0403921568103998 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -7.5021374427586438e-16 6.8503969880964952e-15 -12.499557951878339 ;
	setAttr ".radi" 0.50566109125997294;
createNode joint -n "joint9" -p "joint8";
	rename -uid "4E3AF9D8-4FEA-2F4B-CCBC-36933730DB85";
	setAttr ".t" -type "double3" 1.1244401010393823 0.13583615100964411 -1.2838881935107078 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 180 53.240711829707948 ;
	setAttr ".radi" 0.50566109125997294;
createNode joint -n "joint10" -p "joint19";
	rename -uid "45C93663-4EFD-F01F-47BF-B8B62FB2B10A";
	setAttr ".t" -type "double3" 0.12131718585192353 2.4601805722044991 1.89226 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 50.101370382910936 ;
	setAttr ".radi" 0.5221144307817196;
createNode joint -n "joint11" -p "joint10";
	rename -uid "FEB78788-4E96-4D8F-1F41-A7BF279F7BD4";
	setAttr ".t" -type "double3" -0.62294258359781196 0.16528531011703373 1.0403900000000001 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 1.2074182704759468e-06 -6.8503971681061185e-15 -12.499557951878309 ;
	setAttr ".radi" 0.50566109125997294;
createNode joint -n "joint12" -p "joint11";
	rename -uid "5D2D98EF-456F-A35B-F115-B8A1E8AEEE6A";
	setAttr ".t" -type "double3" -1.1244378660931975 -0.13583495148704983 1.283890002862508 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 1.0762294521154498e-06 180.00000096733135 53.240711829707898 ;
	setAttr ".radi" 0.50566109125997294;
createNode joint -n "joint1" -p "joint17";
	rename -uid "E15C4787-4152-8611-327B-6D82E25658EA";
	setAttr ".t" -type "double3" -0.49862066434185692 -2.3581905336705673 0.43441662586435553 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 90 -45.643745714175388 -179.99999999999997 ;
	setAttr ".radi" 0.52033596762395284;
createNode joint -n "joint2" -p "joint1";
	rename -uid "DFC7C1BE-4031-935C-3099-F0941C2AD37B";
	setAttr ".t" -type "double3" 1.3931620407297556 -5.7363448508204094e-16 -0.58706251606475091 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -2.534484782078208e-17 -6.9499761511328485e-16 4.1770203639172472 ;
	setAttr ".radi" 0.5157123000577698;
createNode joint -n "joint3" -p "joint2";
	rename -uid "FD52CA2B-422B-CCDD-3AB7-0CB3779C7484";
	setAttr ".t" -type "double3" 1.3037711344502163 -4.916015969080338e-16 -0.54811651835367181 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -40.179233921907354 90 0 ;
	setAttr ".radi" 0.5157123000577698;
createNode joint -n "joint4" -p "joint17";
	rename -uid "B8381C4C-49D1-09E8-FC5D-078BD3821234";
	setAttr ".t" -type "double3" -0.49862212459171884 2.4120307089801751 0.434417 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -90 45.643745714175402 3.8166656177562201e-14 ;
	setAttr ".radi" 0.52033596762395284;
createNode joint -n "joint5" -p "joint4";
	rename -uid "AB217E6B-4E4B-EFB0-4AA9-FCBCDB57F1EA";
	setAttr ".t" -type "double3" -1.3931611792985135 -4.9573795710688984e-06 0.58706000000000014 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -5.9137978248489178e-17 -1.6216611019309678e-15 4.1770203639171584 ;
	setAttr ".radi" 0.5157123000577698;
createNode joint -n "joint6" -p "joint5";
	rename -uid "9E5649DC-402E-1B10-7830-85A76523D4D5";
	setAttr ".t" -type "double3" -1.3037728734851581 2.2920897446709887e-06 0.54812000000000083 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -40.179233921907453 89.999999999999972 0 ;
	setAttr ".radi" 0.5157123000577698;
createNode joint -n "joint22" -p "joint17";
	rename -uid "45604A1E-4E1C-D202-E6A1-968F8F1ADAED";
	setAttr ".t" -type "double3" 0.68447047051576515 0.72447901302616269 -2.7147731020384107 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 -49.790130722363216 ;
	setAttr ".radi" 0.61829782429471913;
createNode joint -n "joint23" -p "joint22";
	rename -uid "B5BFA95B-4B3B-E658-4727-8C96AEBB8D32";
	setAttr ".t" -type "double3" 3.2870912696979033 -4.4408920985006262e-16 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 32.810419877777164 ;
	setAttr ".radi" 0.63162355470452969;
createNode joint -n "joint24" -p "joint23";
	rename -uid "DA4D8FA9-4BDE-55D8-89F0-7C91D239C699";
	setAttr ".t" -type "double3" 3.5447220576209078 -1.1102230246251565e-16 -0.25701200773338329 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 -71.284584566485492 ;
	setAttr ".radi" 0.62505080164328108;
createNode joint -n "joint25" -p "joint24";
	rename -uid "10923B7E-480A-71AF-6CA7-28B6E994DB3C";
	setAttr ".t" -type "double3" 3.4176488317701019 -5.355196034690058e-15 -0.042188354213689827 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 46.892827566507982 ;
	setAttr ".radi" 0.64270341429989186;
createNode joint -n "joint26" -p "joint25";
	rename -uid "98D309D5-4EB0-6253-02BF-718FF12248F8";
	setAttr ".t" -type "double3" 3.7589326764645756 0 -0.067442509079790991 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 -48.628532155436424 ;
	setAttr ".radi" 0.64270341429989186;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "268DA70B-41C0-17E8-558A-C895C9825EE1";
	setAttr -s 16 ".lnk";
	setAttr -s 16 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "64618431-473F-AA42-69DE-829EE9711909";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "02E516F6-46D0-41EC-DDCB-09B9CB041EFF";
createNode displayLayerManager -n "layerManager";
	rename -uid "85A4F763-496E-9241-3CDE-60A7181221A1";
createNode displayLayer -n "defaultLayer";
	rename -uid "D2D8E249-4CD0-4AE3-0792-5CAFD46B53CE";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "15D59E8F-4E6E-C335-4C39-FE9973711410";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "273805C8-4F42-DD4B-7D53-3A8BCE235C67";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -179.1666595472233 -129.16666153404469 ;
	setAttr ".tgi[0].vh" -type "double2" -23.214284791832927 100.59523409794265 ;
...
createNode groupId -n "groupId9";
	rename -uid "A5A2AC70-4CB0-DC92-06DD-D18FA5EA6635";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts5";
	rename -uid "15AFDC5D-4113-9575-DB72-1F87F296EC14";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0:447]";
...
createNode polyCBoolOp -n "polyCBoolOp1";
	rename -uid "3A951749-425A-8D3D-66EA-238E684328B4";
	setAttr -s 3 ".ip";
	setAttr -s 3 ".im";
	setAttr ".cls" 1;
	setAttr ".mg" -type "Int32Array" 3 13 14 -15 ;
createNode groupId -n "groupId11";
	rename -uid "1A4C8AE3-4CC6-9B48-47F3-0882AF586C6F";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts7";
	rename -uid "5447AE80-4AAA-C5DF-837B-F1B8DFF229D2";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0:959]";
createNode groupId -n "groupId12";
	rename -uid "BD33373D-4136-EE86-FE09-CC9BDD368660";
	setAttr ".ihi" 0;
createNode groupId -n "groupId13";
	rename -uid "F41D906E-42AF-92F8-7B9F-07BC453CBFDB";
	setAttr ".ihi" 0;
createNode polySmoothFace -n "polySmoothFace5";
	rename -uid "DF7BB95D-4DDD-EE78-7F69-25B5635F2DA4";
	setAttr ".ics" -type "componentList" 1 "f[*]";
	setAttr ".sdt" 2;
	setAttr ".suv" yes;
	setAttr ".ps" 0.10000000149011612;
...
connectAttr "groupParts7.og" "pikachu:pCube3Shape.i";
connectAttr "groupId11.id" "pikachu:pCube3Shape.iog.og[0].gid";
connectAttr "lambert3SG.mwc" "pikachu:pCube3Shape.iog.og[0].gco";
connectAttr "groupId12.id" "pikachu:pCube3Shape.ciog.cog[0].cgid";
connectAttr "polySmoothFace5.out" "pikachu:pCubeShape3.i";
...
connectAttr "groupId13.id" "pCube3Shape.ciog.cog[0].cgid";
...
connectAttr "joint21.s" "joint13.is";
connectAttr "joint13.s" "joint14.is";
connectAttr "joint21.s" "joint15.is";
connectAttr "joint15.s" "joint16.is";
connectAttr "joint19.s" "joint7.is";
...
connectAttr "joint17.s" "joint4.is";
connectAttr "joint4.s" "joint5.is";
connectAttr "joint5.s" "joint6.is";
connectAttr "joint17.s" "joint22.is";
...
connectAttr "pikachu:pasted__pCubeShape8.iog" "lambert3SG.dsm" -na;
connectAttr "pikachu:pCubeShape6.iog" "lambert3SG.dsm" -na;
connectAttr "pikachu:pasted__pCubeShape7.iog" "lambert3SG.dsm" -na;
connectAttr "pikachu:pasted__pasted__pCubeShape7.iog" "lambert3SG.dsm" -na;
...
connectAttr "pCube3Shape.iog" "lambert3SG.dsm" -na;
connectAttr "pCube3Shape.ciog.cog[0]" "lambert3SG.dsm" -na;
...
connectAttr "pikachu:pCube3Shape.o" "polyCBoolOp1.ip[2]";
connectAttr "pCubeShape3.wm" "polyCBoolOp1.im[0]";
connectAttr "pCubeShape4.wm" "polyCBoolOp1.im[1]";
connectAttr "pikachu:pCube3Shape.wm" "polyCBoolOp1.im[2]";
connectAttr "pikachu:polySmoothFace5.out" "groupParts7.ig";
connectAttr "groupId11.id" "groupParts7.gi";
connectAttr "polySmoothFace2.out" "polySmoothFace5.ip";
