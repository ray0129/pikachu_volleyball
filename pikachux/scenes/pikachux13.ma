...
//Name: pikachux13.ma
//Last modified: Sat, Jan 05, 2019 11:10:12 PM
//Codeset: 950
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.3428426395746333 16.79122555244621 43.117956321291167 ;
	setAttr ".r" -type "double3" -12.93835272866089 2516.9999999981947 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "96D5F24E-4293-D631-8851-159BCC7D14AA";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 46.242603655455376;
...
createNode transform -n "pikachu:directionalLight1";
	...
	setAttr ".t" -type "double3" -13.233018563628578 0 3.5142077175354762 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "46105C4B-4623-C0FA-1C7A-10B1039A2193";
	setAttr -s 16 ".lnk";
	setAttr -s 16 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "518DFD70-4274-D1FF-BEFB-52AD806CD71D";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "6AE54383-4E70-AEC1-594B-8F84A333D2DD";
createNode displayLayerManager -n "layerManager";
	rename -uid "57C10221-4BAC-1132-BD82-259C729745F3";
createNode displayLayer -n "defaultLayer";
	rename -uid "D2D8E249-4CD0-4AE3-0792-5CAFD46B53CE";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5D1395A2-439E-4824-EB6C-F1A9DB22D929";
...
connectAttr "polyCBoolOp2.out" "pCube9Shape.i";
