...
//Name: pikachux10.ma
//Last modified: Sat, Jan 05, 2019 10:34:09 PM
//Codeset: 950
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.37078357233989201 2.5638460009334159 6.6853362150866342 ;
	setAttr ".r" -type "double3" -21.338352731028817 1435.799999999964 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "96D5F24E-4293-D631-8851-159BCC7D14AA";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 7.1434599802811469;
...
createNode transform -n "pCube4";
	...
	setAttr ".r" -type "double3" -34.125297863926221 -30.428857407304047 102.35764254350768 ;
	setAttr ".s" -type "double3" 0.17838325505791269 0.33056779576749223 0.88771972123791076 ;
createNode transform -n "pCube5" -p "pCube4";
	rename -uid "26DD0638-45A7-C90A-C781-ECBBA17C1BFE";
	setAttr ".t" -type "double3" 0.0053889459278772985 0.013701216150679534 0.0026892670472863202 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "39C122A7-4270-75E8-D202-73AD8E300896";
	setAttr -s 16 ".lnk";
	setAttr -s 16 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "BEB3F0CF-4622-8C9E-4C9A-D392CE9B2F2A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "092427A8-4929-32D7-4D78-82AEEF1D535E";
createNode displayLayerManager -n "layerManager";
	rename -uid "8DDC3A1B-42AD-8B11-B238-B2ABF074528E";
createNode displayLayer -n "defaultLayer";
	rename -uid "D2D8E249-4CD0-4AE3-0792-5CAFD46B53CE";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "9DBC01FC-4C12-9855-0AB1-45876BB0C71F";
